...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        TreasureTypeDao.createTable(db, ifNotExists);
        ImUserInfoDao.createTable(db, ifNotExists);
        SystemInfoEntityDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        TreasureTypeDao.dropTable(db, ifExists);
        ImUserInfoDao.dropTable(db, ifExists);
        SystemInfoEntityDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(TreasureTypeDao.class);
        registerDaoClass(ImUserInfoDao.class);
        registerDaoClass(SystemInfoEntityDao.class);
    }
