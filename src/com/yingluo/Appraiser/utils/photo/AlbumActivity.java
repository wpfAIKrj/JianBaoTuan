...
public class AlbumActivity extends BaseActivity implements OnClickListener {
	...
	private LinkedHashMap<String, ArrayList<String>> mGruopMap = new LinkedHashMap<String, ArrayList<String>>();
	...
	private Handler mHandler = new Handler(Looper.getMainLooper()) {
		...
		public void handleMessage(Message msg) {
			...
			case SCAN_OK:
				...
				imageAdapter = new LocalImageAdapter(AlbumActivity.this, imageList, selectList);
	...
	private void findViews() {
		...
		btn_image_cancel = (ImageView) findViewById(R.id.select_pic_title_btn_cancel);
		imageGridView = (GridView) findViewById(R.id.select_pic_gridview);
		btn_submit = (RelativeLayout) findViewById(R.id.select_pic_submit);
		selectView = (TextView) findViewById(R.id.select_pic_submit_content);
		bt_preview = (RelativeLayout) findViewById(R.id.select_pic_private);
	 ...
	 * @return
	 */
	private ArrayList<ImageBean> subGroupOfImage(HashMap<String, ArrayList<String>> mGruopMap) {
		if (mGruopMap.size() == 0) {
			return null;
		}
