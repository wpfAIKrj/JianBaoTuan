...
public class WeakHandler {
	...
	public WeakHandler(Handler.Callback callback) {
		...
		mExec = new ExecHandler(new WeakReference<Handler.Callback>(mCallback));
	}
	...
	private WeakRunnable wrapRunnable(Runnable r) {
		...
		return hardRef.wrapper = new WeakRunnable(
				new WeakReference<Runnable>(r), new WeakReference<ChainedRef>(
						hardRef));
	}
	...
	static class ChainedRef {
		...
		public void insertAbove(ChainedRef candidate) {
			if (this.next != null) {
