...
public class MyAppraisalTreasureDao extends AbstractDao<MyAppraisalTreasure, Long> {
    ...
    */
    public static class Properties {
        public final static Property Id = new Property(0, Long.class, "id", true, "_id","MY_APPRAISAL_TREASURE");
        public final static Property Treasure_id = new Property(1, Integer.class, "treasure_id", false, "TREASURE_ID","MY_APPRAISAL_TREASURE");
        public final static Property Treasure_owner_id = new Property(2, Integer.class, "treasure_owner_id", false, "TREASURE_OWNER_ID","MY_APPRAISAL_TREASURE");
        public final static Property Appraiser_id = new Property(3, Integer.class, "appraiser_id", false, "APPRAISER_ID","MY_APPRAISAL_TREASURE");
        public final static Property Appraisal_result = new Property(4, Integer.class, "appraisal_result", false, "APPRAISAL_RESULT","MY_APPRAISAL_TREASURE");
        public final static Property Appraisal_data = new Property(5, String.class, "appraisal_data", false, "APPRAISAL_DATA","MY_APPRAISAL_TREASURE");
        public final static Property Is_valid = new Property(6, Integer.class, "is_valid", false, "IS_VALID","MY_APPRAISAL_TREASURE");
        public final static Property Is_appraisal_completed = new Property(7, Integer.class, "is_appraisal_completed", false, "IS_APPRAISAL_COMPLETED","MY_APPRAISAL_TREASURE");
        public final static Property Insert_time = new Property(8, java.util.Date.class, "insert_time", false, "INSERT_TIME","MY_APPRAISAL_TREASURE");
    };
