...
public class TreasureMaterialClassifyDao extends AbstractDao<TreasureMaterialClassify, Long> {
    ...
    */
    public static class Properties {
        public final static Property Id = new Property(0, Long.class, "id", true, "_id","TREASURE_MATERIAL_CLASSIFY");
        public final static Property Classify_name = new Property(1, String.class, "classify_name", false, "CLASSIFY_NAME","TREASURE_MATERIAL_CLASSIFY");
        public final static Property Current_level = new Property(2, Integer.class, "current_level", false, "CURRENT_LEVEL","TREASURE_MATERIAL_CLASSIFY");
        public final static Property Parent_id = new Property(3, Integer.class, "parent_id", false, "PARENT_ID","TREASURE_MATERIAL_CLASSIFY");
        public final static Property Classify_path = new Property(4, String.class, "classify_path", false, "CLASSIFY_PATH","TREASURE_MATERIAL_CLASSIFY");
        public final static Property Is_valid = new Property(5, Integer.class, "is_valid", false, "IS_VALID","TREASURE_MATERIAL_CLASSIFY");
        public final static Property Insert_time = new Property(6, java.util.Date.class, "insert_time", false, "INSERT_TIME","TREASURE_MATERIAL_CLASSIFY");
    };
