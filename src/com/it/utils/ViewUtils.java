...
public class ViewUtils {
	 ...
	 * 设置title高度
	 */
	public static void setViewProportion(Context context,LinearLayout headViewLayout){
//0.1389
		float height =  (0.08223f)*getPhoneHeight(context);
	 ...
	 * 设置title高度
	 */
	public static void setViewProportion(Context context,RelativeLayout headViewLayout){
//0.1389
		float height =  (0.08223f)*getPhoneHeight(context);
		RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT,(int)height);
		headViewLayout.setLayoutParams(params);
	}
